...
class deal_OD():
    ...
    def cal_final_flx(self,area_list,dis_field):
...
bufferList,_=deal.get_buffer_list(field_dis="DIS")
area_list=deal.cal_interect_area(bufferList,pd_fied="PD_INHABIT")
deal.cal_final_flx(area_list=area_list,dis_field=["DIS", "PN_INHABIT", "PD_INHABIT"])
