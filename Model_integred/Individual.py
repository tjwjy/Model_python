    ...
    def simulate(self):
        ...
        while(simulate_time<self.simulate_time):
            ...
            if(t_now<self.work_time[0]and t_now>=self.rest_time[1]):
                #pass
                temp_Model=Model_inter.Commute_Model(self.args_model,self.args_t,self.args_steps,self.Envir,self.commute_LocationList,self.home_loc,self.work_loc)
            ...
            if(t_now>self.work_time[0] and t_now<self.work_time[1]):
                #pass
                temp_Model =Model_inter.HomeOrWork_Model(self.args_model,self.args_t,self.args_steps,self.Envir,self.work_locatonList,self.home_loc,self.work_loc)
            ...
            if(t_now>self.work_time[1] and t_now<self.rest_time[0]):
                ...
                if(t_now<self.rest_time[0]):
                    temp_Model = Model_inter.HomeOrWork_Model(self.args_model,self.args_t,self.args_steps,self.Envir,self.home_locationList,self.home_loc,self.work_loc)
...
class Nomal_Network_Individual(Individual):
    ...
    def simulate(self):
        ...
        while (simulate_time < self.simulate_time):
            ...
            if (t_now < self.work_time[0] and t_now >= self.rest_time[1]):
                # pass
                temp_Model = Model_inter.Commute_Model(self.args_model, self.args_t, self.args_steps, self.Envir,
            ...
            if (t_now > self.work_time[0] and t_now < self.work_time[1]):
                # pass
                temp_Model = Model_inter.HomeOrWork_Model(self.args_model, self.args_t, self.args_steps, self.Envir,
