...
class Nomal_Network_Individual(Individual):
    ...
    def simulate(self):
        ...
        while (simulate_time < self.simulate_time):
            ...
            if (t_now < self.work_time[0] and t_now >= self.rest_time[1]):
                # pass
                temp_Model = Model5.Commute_Model(self.args_model, self.args_t, self.args_steps, self.Envir,
            ...
            if (t_now > self.work_time[0] and t_now < self.work_time[1]):
                # pass
                temp_Model = Model5.HomeOrWork_Model(self.args_model, self.args_t, self.args_steps, self.Envir,
